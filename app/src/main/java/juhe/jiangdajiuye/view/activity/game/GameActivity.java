package juhe.jiangdajiuye.view.activity.game;
...
public class Game extends BaseActivity implements ListView.OnItemClickListener{
    ...
    public void upDate(){
        adapter = new GameAdapter(this,data,
                R.layout.game_item,
                new String[]{"image","title","MessageBean","visit"},
    ...
    private void shareToWX(){
        ...
        ToastUtils.showToast(ResourceUtils.getString(R.string.share_toast));
        ...
        message.description = ResourceUtils.getString(R.string.share_app_description);
